  ...
  const insights = [
    {
      ...
      desc: `Vous avez enregistré ${stats.totalTx} transaction${stats.totalTx > 1 ? "s" : ""} au total.`,
      bg: "bg-secondary/10",
    ...
    },
    {
      ...
      desc: `${stats.dominante} représente votre principale source de dépenses.`,
      bg: "bg-warning/10",
    ...
    },
    {
      icon: "💡",
      title: "Conseil",
      desc: "Ajoutez des transactions régulièrement pour obtenir des insights personnalisés plus précis.",
      bg: "bg-success/10",
    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-tertiary text-sm mt-1">
          Indicateurs clés et tendances de vos finances.
        </p>
      </div>
      ...
      <div className="grid grid-cols-4 gap-4">
        {[
          ...
          {
            label: "Streak d'épargne",
            value: `${stats.epargneStreak} mois`,
            sub: "Consécutifs dans le vert",
            icon: Flame,
        ...
        <div className="bg-white border border-border rounded-2xl p-6">
          ...
          <div className="h-5 mb-3">
            {hoveredBar !== null && weeklyData[hoveredBar] && (
              <p className="text-xs text-tertiary">
                {weeklyData[hoveredBar].day} —{" "}
                <span className="text-danger font-semibold">
                  {format(weeklyData[hoveredBar].amount)}
                </span>
              </p>
            )}
          </div>
          {weeklyData.every((d) => d.amount === 0) ? (
            ...
            <div className="flex items-end gap-2" style={{ height: "160px" }}>
              {weeklyData.map((d, i) => {
                const isMax =
                  d.amount === Math.max(...weeklyData.map((x) => x.amount));
                return (
                  <div
                    key={i}
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="w-full bg-neutral rounded-full h-1.5">
                      <div
                        ...
                        style={{
                          width: `${(d.amount / maxTopAmount) * 100}%`,
          ...
          {insights.map((insight) => (
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                ...
                <p className={`text-sm font-bold ${insight.titleColor}`}>
                  {insight.title}
                </p>
              </div>
